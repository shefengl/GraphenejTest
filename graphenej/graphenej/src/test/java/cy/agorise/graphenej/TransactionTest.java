...
public class TransactionTest {
    ...
    private final String NODE_CYB_TEST = "http://39.106.211.243:8090";
    private final String NODE_CYB_TEST2 = "wss://hangzhou.51nebula.com";
    ...
    private final UserAccount cybx_1 = new UserAccount("1.2.102598");
    ...
    private void broadcastTransaction(ECKey privateKey, List<BaseOperation> operationList, WitnessResponseListener responseListener, Object lockObject) {
        try {
            ...
            WebSocket mWebSocket = factory.createSocket(NODE_CYB_TEST2);
    ...
    public void testCreateAccountTransaction() {
            ...
            System.out.println("Fee: " + Util.bytesToHex(new AssetAmount(UnsignedLong.valueOf(515), CORE_ASSET).toBytes()));
